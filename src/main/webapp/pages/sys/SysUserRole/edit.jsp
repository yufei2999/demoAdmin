				...
				onSubmit:function(){
					...
					if(result.code=="0000"){
						$.messager.alert('提示', "操作成功！", 'info',function(){
							window.location.href="${ctx}/sysUserRole/list";
						});
					}else{
...
<body>
<h2><%=SysUserRole.TABLE_ALIAS%>编辑</h2>
<p>请填写完整信息并保存.</p>
<div style="margin:20px 0;"></div>
<div class="easyui-panel" title="信息编辑" style="width:600px">
	<div style="padding:10px 60px 20px 60px">
		<form id="ff" action="${ctx}/sysUserRole/update" method="post" class="easyui-form" data-options="novalidate:true">
			...
			<tr>
				...
				<td>
					<input id="userId" name="userId" value="${model.userId}"
						   type="text"  class="easyui-textbox"  data-options="prompt:'请输入<%=SysUserRole.ALIAS_USER_ID%>',required:true,validType:'length[0,50]'" />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input id="roleId" name="roleId" value="${model.roleId}"
						   type="text"  class="easyui-textbox"  data-options="prompt:'请输入<%=SysUserRole.ALIAS_ROLE_ID%>',required:true,validType:'length[0,50]'" />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input id="creator" name="creator" value="${model.creator}"
						   type="text"  class="easyui-textbox"  data-options="prompt:'请输入<%=SysUserRole.ALIAS_CREATOR%>',required:true,validType:'length[0,50]'" />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input value="${model.createTimeString}" id="createTimeString" name="createTimeString"
						   type="text" class="easyui-datetimebox"  editable="false"  data-options="prompt:'请输入<%=SysUserRole.ALIAS_CREATE_TIME%>'" />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input id="lastModifier" name="lastModifier" value="${model.lastModifier}"
						   type="text"  class="easyui-textbox"  data-options="prompt:'请输入<%=SysUserRole.ALIAS_LAST_MODIFIER%>',validType:'length[0,50]'" />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input value="${model.lastModifyTimeString}" id="lastModifyTimeString" name="lastModifyTimeString"
						   type="text" class="easyui-datetimebox"  editable="false"  data-options="prompt:'请输入<%=SysUserRole.ALIAS_LAST_MODIFY_TIME%>'" />
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<input id="deleted" name="deleted" value="${model.deleted}"
						   type="text"  class="easyui-numberbox"  data-options="prompt:'请输入<%=SysUserRole.ALIAS_DELETED%>',required:true,min:0,max:10000" />
				</td>
			</tr>
		</table>
		</form>
