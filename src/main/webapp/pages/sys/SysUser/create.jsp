...
<body>
<h2><%=SysUser.TABLE_ALIAS%>新增</h2>
<p>请填写完整信息并保存.</p>
<div style="margin:20px 0;"></div>
<div class="easyui-panel" title="信息保存" style="width:600px">
    <div style="padding:10px 60px 20px 60px">
        <form id="ff" action="${ctx}/sysUser/save" method="post" class="easyui-form" data-options="novalidate:true">
            ...
            <tr>
                ...
                <td>
                    <input id="userName"
                       ...
                       data-options="prompt:'请输入<%=SysUser.ALIAS_USER_NAME%>',required:true,validType:'length[0,50]'"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input id="showName"
                       ...
                       type="text" class="easyui-textbox"
                       data-options="prompt:'请输入<%=SysUser.ALIAS_SHOW_NAME%>',required:true,validType:'length[0,50]'"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input id="password"
                       ...
                       type="password" class="easyui-textbox"
                       data-options="prompt:'请输入<%=SysUser.ALIAS_PASSWORD%>',required:true,validType:'length[0,50]'"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input id="mobile"
                       ...
                       value="${model.mobile}"
                       type="text" class="easyui-textbox"
                       data-options="prompt:'请输入<%=SysUser.ALIAS_MOBILE%>',validType:'length[0,50]'"/>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input id="remark"
                       ...
                       value="${model.remark}"
                       type="text" class="easyui-textbox"
                       data-options="prompt:'请输入<%=SysUser.ALIAS_REMARK%>',validType:'length[0,50]'"/>
                </td>
            </tr>
        </table>
        </form>
