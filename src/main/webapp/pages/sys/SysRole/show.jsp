...
<head>
	<meta charset="UTF-8">
	<title><%=SysRole.TABLE_ALIAS%>详情</title>
...
<div class="easyui-panel" title="信息详情" style="width:600px">
	...
	<!-- ONGL access static field: @package.class@field or @vs@field -->
			<tr>
				...
				<td>
					<input  value="${model.roleName}" id="roleName" name="roleName" type="text"  class="easyui-textbox"  readonly="readonly"  />
				</td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td>
					<%=SysRole.ALIAS_LAST_MODIFY_TIME%>:
				</td>
				<td>
