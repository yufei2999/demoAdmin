...
<head>
    <meta charset="UTF-8">
    <title><%=SysRoleFunc.TABLE_ALIAS%>新增</title>
...
<body>
<h2><%=SysRoleFunc.TABLE_ALIAS%>新增</h2>
<p>请填写完整信息并保存.</p>
<div style="margin:20px 0;"></div>
<div class="easyui-panel" title="信息保存" style="width:600px">
    <div style="padding:10px 60px 20px 60px">
        <form id="ff" action="${ctx}/sysRoleFunc/save" method="post" class="easyui-form" data-options="novalidate:true">
            ...
            <tr>
                ...
                <td>
                    <input id="roleId"
                       ...
                       data-options="prompt:'请输入<%=SysRoleFunc.ALIAS_ROLE_ID%>',required:true,validType:'length[0,50]'"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input id="funcId"
                       ...
                       value="${model.funcId}"
                       type="text" class="easyui-textbox"
                       data-options="prompt:'请输入<%=SysRoleFunc.ALIAS_FUNC_ID%>',required:true,validType:'length[0,50]'"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input id="creator"
                       ...
                       value="${model.creator}"
                       type="text" class="easyui-textbox"
                       data-options="prompt:'请输入<%=SysRoleFunc.ALIAS_CREATOR%>',required:true,validType:'length[0,50]'"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input value="${model.createTimeString}"
                           ...
                           data-options="prompt:'请输入<%=SysRoleFunc.ALIAS_CREATE_TIME%>'"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input id="lastModifier"
                       ...
                       type="text" class="easyui-textbox"
                       data-options="prompt:'请输入<%=SysRoleFunc.ALIAS_LAST_MODIFIER%>',validType:'length[0,50]'"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input value="${model.lastModifyTimeString}"
                           ...
                           type="text" class="easyui-datetimebox" editable="false"
                           data-options="prompt:'请输入<%=SysRoleFunc.ALIAS_LAST_MODIFY_TIME%>'"/>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input id="deleted"
                       ...
                       data-options="prompt:'请输入<%=SysRoleFunc.ALIAS_DELETED%>',required:true,min:0,max:10000"/>
                </td>
            </tr>
        </table>
        </form>
