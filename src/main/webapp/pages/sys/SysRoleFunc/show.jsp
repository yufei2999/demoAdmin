...
<head>
	<meta charset="UTF-8">
	<title><%=SysRoleFunc.TABLE_ALIAS%>详情</title>
...
<body>
<h2><%=SysRoleFunc.TABLE_ALIAS%>详情</h2>
<p>以下是已填写的信息.</p>
...
<div class="easyui-panel" title="信息详情" style="width:600px">
	...
	<!-- ONGL access static field: @package.class@field or @vs@field -->
			...
			<tr>
				...
				<td>
					<input  value="${model.funcId}" id="funcId" name="funcId" type="text"  class="easyui-textbox"  readonly="readonly"  />
				</td>
			</tr>
			<tr>
				<td>
